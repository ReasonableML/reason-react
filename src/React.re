...
module Children = {
  ...
  external mapWithIndex:
    (element, [@uncurry] ((element, int) => element)) => element =
    "map";
  [@module "react"] [@scope "Children"]
  external forEach: (element, element => unit) => unit = "forEach";
  [@module "react"] [@scope "Children"]
  external forEachWithIndex:
    (element, [@uncurry] ((element, int) => unit)) => unit =
    "forEach";
  [@module "react"] [@scope "Children"]
...
[@module "react"]
external forwardRef:
  ([@uncurry] (('props, Js.Nullable.t(ref('a))) => element)) =>
  component('props) =
  "forwardRef";
...
external memoCustomCompareProps:
  (component('props), [@uncurry] (('props, 'props) => bool)) =>
  component('props) =
  "memo";
...
[@module "react"]
external useReducer:
  ([@uncurry] (('state, 'action) => 'state), 'state) =>
  ('state, 'action => unit) =
  "useReducer";
...
[@module "react"]
external useEffect: ([@uncurry] (unit => option(unit => unit))) => unit =
  "useEffect";
[@module "react"]
external useEffect0:
  ([@uncurry] (unit => option(unit => unit)), [@as {json|[]|json}] _) => unit =
  "useEffect";
[@module "react"]
external useEffect1:
  ([@uncurry] (unit => option(unit => unit)), array('a)) => unit =
  "useEffect";
[@module "react"]
external useEffect2:
  ([@uncurry] (unit => option(unit => unit)), ('a, 'b)) => unit =
  "useEffect";
[@module "react"]
external useEffect3:
  ([@uncurry] (unit => option(unit => unit)), ('a, 'b, 'c)) => unit =
  "useEffect";
[@module "react"]
external useEffect4:
  ([@uncurry] (unit => option(unit => unit)), ('a, 'b, 'c, 'd)) => unit =
  "useEffect";
[@module "react"]
external useEffect5:
  ([@uncurry] (unit => option(unit => unit)), ('a, 'b, 'c, 'd, 'e)) => unit =
  "useEffect";
[@module "react"]
external useEffect6:
  ([@uncurry] (unit => option(unit => unit)), ('a, 'b, 'c, 'd, 'e, 'f)) =>
  unit =
  "useEffect";
[@module "react"]
external useEffect7:
...
[@module "react"]
external useLayoutEffect: ([@uncurry] (unit => option(unit => unit))) => unit =
  "useLayoutEffect";
[@module "react"]
...
[@module "react"]
external useMemo0: ([@uncurry] (unit => 'any), [@as {json|[]|json}] _) => 'any =
  "useMemo";
[@module "react"]
...
[@module "react"]
external useMemo3: ([@uncurry] (unit => 'any), ('a, 'b, 'c)) => 'any =
  "useMemo";
[@module "react"]
external useMemo4: ([@uncurry] (unit => 'any), ('a, 'b, 'c, 'd)) => 'any =
  "useMemo";
[@module "react"]
external useMemo5: ([@uncurry] (unit => 'any), ('a, 'b, 'c, 'd, 'e)) => 'any =
  "useMemo";
[@module "react"]
external useMemo6:
  ([@uncurry] (unit => 'any), ('a, 'b, 'c, 'd, 'e, 'f)) => 'any =
  "useMemo";
[@module "react"]
external useMemo7:
  ([@uncurry] (unit => 'any), ('a, 'b, 'c, 'd, 'e, 'f, 'g)) => 'any =
  "useMemo";
...
external useCallback:
  ([@uncurry] ('input => 'output)) => callback('input, 'output) =
  "useCallback";
[@module "react"]
external useCallback0:
  ([@uncurry] ('input => 'output), [@as {json|[]|json}] _) =>
  callback('input, 'output) =
  "useCallback";
[@module "react"]
external useCallback1:
  ([@uncurry] ('input => 'output), array('a)) => callback('input, 'output) =
  "useCallback";
[@module "react"]
external useCallback2:
  ([@uncurry] ('input => 'output), ('a, 'b)) => callback('input, 'output) =
  "useCallback";
[@module "react"]
external useCallback3:
  ([@uncurry] ('input => 'output), ('a, 'b, 'c)) => callback('input, 'output) =
  "useCallback";
[@module "react"]
external useCallback4:
  ([@uncurry] ('input => 'output), ('a, 'b, 'c, 'd)) =>
  callback('input, 'output) =
  "useCallback";
[@module "react"]
external useCallback5:
  ([@uncurry] ('input => 'output), ('a, 'b, 'c, 'd, 'e)) =>
  callback('input, 'output) =
  "useCallback";
[@module "react"]
external useCallback6:
  ([@uncurry] ('input => 'output), ('a, 'b, 'c, 'd, 'e, 'f)) =>
  callback('input, 'output) =
  "useCallback";
[@module "react"]
external useCallback7:
  ([@uncurry] ('input => 'output), ('a, 'b, 'c, 'd, 'e, 'f, 'g)) =>
  callback('input, 'output) =
  "useCallback";
...
external useImperativeHandle1:
  (Js.Nullable.t(ref('value)), [@uncurry] (unit => 'value), array('a)) =>
  unit =
  "useImperativeHandle";

[@module "react"]
external useImperativeHandle2:
  (Js.Nullable.t(ref('value)), [@uncurry] (unit => 'value), ('a, 'b)) =>
  unit =
  "useImperativeHandle";

[@module "react"]
external useImperativeHandle3:
  (Js.Nullable.t(ref('value)), [@uncurry] (unit => 'value), ('a, 'b, 'c)) =>
  unit =
  "useImperativeHandle";
