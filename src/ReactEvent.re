...
module MakeEventWithType = (Type: {type t;}) => {
  ...
  [@get] external currentTarget: Type.t => Js.t({..}) = "currentTarget"; /* Should return Dom.eventTarget */
  ...
  [@get] external nativeEvent: Type.t => Js.t({..}) = "nativeEvent"; /* Should return Dom.event */
  ...
  [@get] external target: Type.t => Js.t({..}) = "target"; /* Should return Dom.eventTarget */
...
module Synthetic = {
  ...
  [@get] external target: synthetic('a) => Js.t({..}) = "target"; /* Should return Dom.eventTarget */
...
module Clipboard = {
  ...
  [@get] external clipboardData: t => Js.t({..}) = "clipboardData"; /* Should return Dom.dataTransfer */
};
...
module Touch = {
  ...
  [@get] external altKey: t => bool = "altKey";
  [@get] external changedTouches: t => Js.t({..}) = "changedTouches"; /* Should return Dom.touchList */
  [@get] external ctrlKey: t => bool = "ctrlKey";
  [@send]
  external getModifierState: (t, string) => bool = "getModifierState";
  [@get] external metaKey: t => bool = "metaKey";
  [@get] external shiftKey: t => bool = "shiftKey";
  [@get] external targetTouches: t => Js.t({..}) = "targetTouches"; /* Should return Dom.touchList */
  [@get] external touches: t => Js.t({..}) = "touches"; /* Should return Dom.touchList */
};
